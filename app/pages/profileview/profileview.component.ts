		...
		<StackLayout>
			...
			<StackLayout id="information">
				<GridLayout rows="auto" columns="*,35,110" id="edit">
					<Image src="~/images/edit.png" width="25" height="25" (tap)="makeChanges()" row="0" col="1"></Image>
					<Label text="Edit Profile" id="edit-label"   		  (tap)="makeChanges()" row="0" col="2" ></Label>
				</GridLayout>
				
				<Label text="Account Information" class="title"></Label>
				<GridLayout rows="auto,auto,auto" columns="*,*" id="account">
				...
				<GridLayout rows="auto,auto,auto,auto,auto" columns="*,*" id="personal">
			...
			<GridLayout rows="auto" columns="*,*" id="histories">
				<Button text="Shuttle History" (tap)="seeShuttle()" width="{{buttonW}}" class="history" row="0" col="0"></Button>
				<Button text="Charter History" (tap)="seeCharter()" width="{{buttonW}}" class="history" row="0" col="1"></Button>
			</GridLayout>
		</StackLayout>
    </ScrollView>
  `,
